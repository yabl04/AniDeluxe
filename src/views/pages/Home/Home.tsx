      ...
      >
        <div className="container px-6 md:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            <motion.div variants={fadeInUp} className="lg:w-1/2 space-y-8 z-10">
              ...
              >
                Исследуйте огромную коллекцию аниме, следите за новинками и
                наслаждайтесь просмотром в высоком качестве на любом устройстве
              </motion.p>
                ...
                <div className="aspect-video rounded-xl overflow-hidden relative bg-dark-800">
                  ...
                  <div className="absolute inset-0 flex items-center justify-between px-4 opacity-0 hover:opacity-100 transition-opacity duration-300">
                    <button
                      onClick={() =>
                        setCurrentVideoIndex(prev =>
                          prev === 0 ? trailerVideos.length - 1 : prev - 1,
                        )
                      }
                    ...
                    <button
                      onClick={() =>
                        setCurrentVideoIndex(prev =>
                          prev === trailerVideos.length - 1 ? 0 : prev + 1,
                        )
                      }
                      className="p-2 rounded-full bg-black/50 backdrop-blur-sm text-white hover:bg-black/70 transition-all"
                    >
        ...
        <div className="absolute bottom-0 left-0 w-full h-16 overflow-hidden">
          ...
          >
            <path
              d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.72C57.71,59.42,158.75,88.95,228.87,101.86Z"
        ...
        >
          <div className="container px-6 md:px-8">
            ...
            >
              ...
              <NavLink
                to="/anime"
                className="hidden sm:flex items-center gap-2 text-primary-400 hover:text-primary-500 transition-colors duration-300"
              >
            ...
            <div className="flex sm:hidden justify-center mt-8">
              <NavLink
                to="/anime"
                className="btn-custom bg-dark-800/60 backdrop-blur-md hover:bg-dark-700/60 border border-gray-700/50 text-gray-200 rounded-xl px-6 py-3 flex items-center gap-2 font-medium transition-all"
              >
            ...
            <div className="relative overflow-hidden rounded-2xl">
              ...
              <div className="relative z-10 flex flex-col items-center text-center py-16 px-8">
                ...
                <p className="text-xl text-gray-300 mb-10 max-w-2xl">
                  ...
                  удивительный мир аниме прямо сейчас!
                </p>
