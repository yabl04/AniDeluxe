      ...
      <div className="container mx-auto px-4 relative z-20 -mt-48 md:-mt-64">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-start gap-8 lg:gap-16">
            {/* Постер и информация */}
            <motion.div variants={fadeInUp} className="md:w-1/3 lg:w-1/4 z-10">
                ...
                {activeTab === 'description' && (
                  ...
                  >
                    ...
                    <div className="bg-dark-800/60 backdrop-blur-xl rounded-3xl p-8 border border-dark-700/60 shadow-xl">
                      <h3 className="text-xl font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-primary-500">
                        Описание
                      </h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-dark-800/60 backdrop-blur-xl rounded-3xl p-6 border border-dark-700/60 shadow-xl">
                        <h3 className="text-lg font-semibold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-primary-400 to-primary-500">
                          Информация
                        </h3>
                        <ul className="space-y-3">
                          <li className="flex justify-between items-center py-2 border-b border-dark-700/30">
                            <span className="text-gray-400">Статус:</span>
                            <span className="px-3 py-1 bg-primary-500/10 rounded-lg text-white">
                              Онгоинг
                            </span>
                          </li>
                          <li className="flex justify-between items-center py-2 border-b border-dark-700/30">
                        ...
                        <div className="flex items-center justify-center">
                          <div className="relative">
                            ...
                            <div className="relative bg-dark-800/80 px-6 py-4 rounded-2xl border border-primary-500/30 flex items-center gap-3">
                              ...
                              <span className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-yellow-600">
                                9.2
                              </span>
